...
sources:
  ...
  - https://investors.alector.com/news-releases/news-release-details/alector-announces-completion-enrollment-progress-ad-phase-2
  - https://www.biospace.com/drug-development/alector-scraps-dementia-drug-after-phase-iii-flop-lays-off-49-of-staff
---
...
## 플랫폼
- Sortilin 수용체 조절 (라토지네맙 → 실패 후 종료)
- PGRN 상향 조절 (나비스네바트/AL101)
- ABC(Alector Brain Carrier) BBB 통과 기술

## 적응증
전두측두엽 치매(FTD-GRN, 종료), 초기 알츠하이머병(AD, 나비스네바트 Phase 2)

## 파트너
- GSK (나비스네바트/AL101 공동개발)
...
## 임상 디자인
- NCT: NCT05469009 (PROGRESS-AD)
- Phase: Phase 2
- N: 367명 (등록 완료 2025-04)
...
아밀로이드·타우 병리와 함께 신경염증(microglia 기능장애)이 진행성 인지저하를 유발하는 신경퇴행 질환.

- 환자 수: 미국 약 650만 명, 전 세계 약 5,500만 명
- 병리: PGRN(progranulin) 결핍 → 마이크로글리아 기능장애 → 리소좀 기능 저하·신경염증 악화 → 신경세포 손실 가속화.
...
Anti-PGRN 항체 (type: Antibody) — PGRN 수준 상향 조절 작용

정맥주사 단클론항체. PGRN에 결합해 PGRN의 분해(SORT1 매개)를 억제 → 세포외 PGRN 농도 증가. GSK와 공동 개발.

## MOA
- 타겟: Progranulin (PGRN)
- 기전: 나비스네바트가 PGRN에 결합해 SORT1 수용체를 통한 리소좀 분해 차단 → 혈중 및 CSF PGRN 농도 증가 → 마이크로글리아 리소좀 기능 회복 → 신경염증 완화, 시냅스 유지.
- 병태생리: AD 및 FTD에서 PGRN 결핍은 마이크로글리아 리소좀 기능장애·염증 촉진·신경세포 손상 연결고리의 핵심. 아밀로이드 제거 항체(레카네맙)와 병용 가능성 탐색 중.

## 논문
- [Bhatt DL et al. Progranulin in neurodegeneration. Nat Rev Neurol (2021)](https://www.nature.com/articles/s41582-021-00541-z)
