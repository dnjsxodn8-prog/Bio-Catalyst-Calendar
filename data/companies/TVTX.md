...
- FY2025 순매출: $410.5M (전년 $233.2M → +76% YoY 전체)
  - Filspari(sparsentan): $322M (+144% YoY)
- 2026 guidance: 미공개 (Q1 2026 실적 발표 예정 2026-05-04)

## 플랫폼
- Small Molecule (Dual ETAR/AT1R antagonist — sparsentan)
- Enzyme Replacement Therapy (pegtibatinase — PEG화 시스타티오닌 β-합성효소 대체효소)

## 적응증
- IgA 신증 (IgAN) — 미국 FDA 완전 승인
- 초점분절성사구체경화증 (FSGS) — 2026-04-13 FDA 완전 승인 (최초)
...
### PROTECT Study (IgAN, NCT03762850)
- 디자인: 무작위배정, 이중맹검, 능동 대조군(active-controlled), 병렬군 Phase 3 국제 다기관
- Arms: Sparsentan 400mg/일 vs Irbesartan 300mg/일 (1:1)
- N: 404명 (성인, IgAN + 단백뇨 ≥1.0 g/일, 최대 RAS 차단제 투여에도 불구)
- Phase: 3 (pivotal)
- Primary endpoint: 36주 UPCR 기저대비 기하평균 변화율 (중간 분석)
- Secondary endpoint: 110주 eGFR 기울기(slope), 단백뇨 변화, 신부전 복합(40% eGFR 감소·ESKD·사망)
- 결과: 36주 UPCR −49.8% (sparsentan) vs −15.1% (irbesartan), P<0.0001; 2년 eGFR slope 통계적 유의 개선

### DUPLEX Study (FSGS, NCT03493685)
- 디자인: 무작위배정, 이중맹검, 능동 대조군(irbesartan), 병렬군 Phase 3 국제 다기관
- Arms: Sparsentan 최대 800mg/일 vs Irbesartan 300mg/일 (1:1)
- N: 371명 (8~75세, 생검확인 또는 유전성 FSGS)
- Phase: 3 (pivotal)
- Primary endpoint (미국): Day 1~108주 eGFR total slope; (유럽): 6~108주 eGFR chronic slope
- Secondary endpoint: 36주 FPRE(UPCR ≤1.5 g/g 및 기저대비 >40% 감소), 부분/완전 관해율, ESKD
- 결과: 108주 eGFR slope 개선(P값 0.056, 통계적 유의성 미충족) + 단백뇨/관해율 임상적으로 유의미 → 단백뇨 대리 엔드포인트 기반 2026-04-13 FDA 최종 승인
...
- 기전: AT1R 차단 → Angiotensin II 기인 신장 내 혈관수축·섬유화·염증 억제. ETAR 차단 → Endothelin-1 기인 족세포 손상·사구체 경화·단백뇨 악화 억제. 두 경로를 단일 분자로 동시 차단하여 RAS 단독 억제 대비 우월한 신장 보호 효과.
- 병태생리: IgAN/FSGS 모두 ET-1 및 Ang II 과활성화가 단백뇨 및 신기능 저하를 가속화. 기존 ARB(irbesartan)는 AT1R만 차단 → Sparsentan의 이중 차단이 추가적 사구체·족세포 보호 제공. 항염·항섬유화·혈역학 개선 효과 복합.
