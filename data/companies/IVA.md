...
## 플랫폼
- 범PPAR 작용제 (Pan-PPAR agonist)
- Small Molecule (경구)

## 적응증
Gastrointestinal (MASH/NASH), Rare Disease (점액다당류증 MPS 등)

## 파트너
- AbbVie (MPS 프로그램 파트너십)

## 매출 구조
비수익 단계. 파트너십 마일스톤 수입 중심.
...
대사이상 연관 지방간염. 지방 과축적 + 염증 + 섬유화 → 간경변·간암 진행.

- 환자 수: 미국 ~16백만 명 (MASH 단계), 전 세계 1.5억+
- 병리: 지방독성(lipotoxicity) → 산화 스트레스 → 간세포 손상 → 염증·섬유화 → 간경변
...
## Modality
**Lanifibranor**
Pan-PPAR (α/δ/γ) agonist (type: Small Molecule)

경구 투여 1일 1회. 세 가지 PPAR 서브타입 동시 활성화 → 지방 산화 촉진, 인슐린 감수성 개선, 항섬유화, 항염 복합 효과.

## MOA
- 타겟: PPARα, PPARδ, PPARγ (범PPAR)
- 기전: PPARα 활성 → 지방산 β-산화 촉진; PPARδ 활성 → 간 염증 억제, 근육 지방산 산화; PPARγ 활성 → 인슐린 감수성 개선, 지방 분화 조절 → TGF-β 신호 억제 → 항섬유화
- 병태생리: MASH에서 PPAR 활성 전반 감소 → 지방 축적·염증·섬유화 악순환. 범PPAR 활성화로 다중 병태 경로 동시 차단.

## 논문
- [Francque SMA et al. Lanifibranor in Patients with Active NASH — NATIVE Trial. NEJM (2021)](https://www.nejm.org/doi/full/10.1056/NEJMoa2036205)
