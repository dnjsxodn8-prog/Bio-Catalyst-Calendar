...
sources:
  ...
  - https://www.prnewswire.com/news-releases/whitehawk-therapeutics-reports-fourth-quarter-and-full-year-2025-financial-results-and-recent-highlights-302711592.html
  - https://www.prnewswire.com/news-releases/whitehawk-therapeutics-presents-comprehensive-preclinical-data-highlighting-its-next-generation-adc-portfolio-at-the-aacr-2026-302746115.html
  - https://www.prnewswire.com/news-releases/whitehawk-therapeutics-advances-to-clinical-stage-with-ind-clearance-for-hwk-007-and-announces-ind-submission-for-hwk-016-302655806.html
  - https://www.prnewswire.com/news-releases/aadi-bioscience-relaunches-as-whitehawk-therapeutics-marking-evolution-into-adc-company-302405009.html
---

# Whitehawk Therapeutics (WHWK)

## 카탈리스트
- **HWK-007/HWK-016 Phase 1 초기 데이터** — 2027년 상반기 예상 (폐암·난소암·자궁내막암)
- **HWK-206 IND 제출** — 2026년 중반 예정 (SCLC·신경내분비종양)
...
- HWK-007, HWK-016: 단일특이적(monospecific) ADC
- HWK-206: 이파라토픽(biparatopic) ADC — SEZ6 두 개 에피토프 동시 결합

## 적응증
- 비소세포폐암 (NSCLC, 비편평상피·EGFR 야생형)
- 백금내성 난소암
- 자궁내막암
- 소세포폐암 (SCLC)
- 신경내분비 종양 (Neuroendocrine Neoplasm)

## 파트너
- **WuXi Biologics** — HWK-007/016/206 독점 글로벌 개발·상업화 라이선스 원천
- **Hangzhou DAC Biotech** — ADC 링커-페이로드 플랫폼 (WuXi 통해 서브라이선스)
- **Kaken Pharmaceuticals** — FYARRO·Aadi 자회사 인수 (2025.3 완료)

## 매출 구조
없음 (전임상~Phase 1 단계). 자체 상업 제품 0. 전액 자기 자본·현금으로 운영.

## 자체 판매
아니오 (상업화 이전). 향후 성공 시 독자 상업화 또는 빅파마 파트너링 모두 가능.
...
## 기존 치료제
- **백금내성 난소암**: 도세탁셀, 파클리탁셀, 젬시타빈, 토포테칸, 벨립+나브-파클리탁셀(Corifact·relacorilant, FDA 2024 승인), PARP억제제(BRCA 변이). 전반적 ORR 10~15%, PFS 3~4개월 수준으로 미충족 수요 큼
- **EGFR WT NSCLC**: 백금 기반 항암제+면역관문억제제(pembrolizumab). PTK7 타겟 ADC 없음
...
## 논문
- [Whitehawk AACR 2026 프레스릴리즈 — HWK-007/016/206 전임상 종합 데이터](https://www.prnewswire.com/news-releases/whitehawk-therapeutics-presents-comprehensive-preclinical-data-highlighting-its-next-generation-adc-portfolio-at-the-aacr-2026-302746115.html)
- [Gao Y et al. PTK7-targeted ADC reduces tumor-initiating cells. Science Translational Medicine (2017)](https://www.science.org/doi/abs/10.1126/scitranslmed.aag2611)
- [Peng D et al. PTK7 in ovarian cancer EMT and cell plasticity. Cell Death & Disease (2022)](https://www.nature.com/articles/s41419-022-05161-5)
- [MUC16 (CA125): tumor biomarker to cancer therapy. Molecular Cancer (2014)](https://link.springer.com/article/10.1186/1476-4598-13-129)

## 메모
- 구 Aadi Bioscience (FYARRO/nab-sirolimus) → 2025.3 ADC 순수 플레이어로 전환. 리브랜딩·자산 교체 완료
- 3개 프로그램 모두 Hangzhou DAC 동일 링커-페이로드 플랫폼 사용 → 개발 리스크 집중·플랫폼 검증 시너지 동시 존재
- HWK-016은 sofituzumab vedotin(항원 싱크 실패) 교훈을 반영한 차별화 설계. 경쟁사 대비 명확한 차별점
- HWK-206은 SCLC 유일 biparatopic ADC. ABBV-706(AbbVie) Phase 1이 경쟁 레퍼런스
- 핵심 카탈리스트는 2027H1 HWK-007/016 첫 임상 데이터. 그 전까지는 IND/개시 뉴스 플로우
- 현금 $145.7M / 런웨이 2028년 → 희석 리스크 낮음. 소규모(직원 23명) 린 오퍼레이션
